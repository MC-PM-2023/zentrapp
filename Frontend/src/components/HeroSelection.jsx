...
// const HeroSelection = ({ apps = [], heroLogos = [] }) => {

//   // Determine main logo + floating logos
...
//         }
//         @keyframes orbit {
//           from { transform: rotate(0deg) translateX(6px); }
//           to   { transform: rotate(360deg) translateX(6px); }
//         }
//       `}</style>

//       {/* Hero Box */}
//       <div className="position-relative rounded shadow-sm border bg-white mb-4"
//            style={{ height: "450px", overflow: "hidden" }}>

//         {/* Background */}
//         <img
//           src="https://storage.googleapis.com/my-react-image-bucket-123/Background%20Images/Background129.jpg"
...
//               <span style={{color:"#0d6efd"}}>Data</span>
//               <span style={{color:"#ff8800"}}>Solve </span>
//               <span style={{color:"#555"}}>Analytics</span>
//             </h1>
